...
export const SHOP_LINKS = [
  // The pack-size hub. First because it is the parent of the pack pages,
  // which are where the per-size detail lives.
      ...
      <div className="shell-wide py-20 sm:py-24">
        <div className="grid gap-10 lg:grid-cols-12">
          ...
          <div className="lg:col-span-2">
            ...
            {/* The logo links to the profile. The score widget joins it only
                once there are reviews worth showing, so a 0.0 TrustScore
                never renders. */}
            <TrustpilotLogoLink onDark className="mt-4" />
            {brand.trustpilot.showRating ? (
              <TrustBox template="microCombo" height="20px" theme="dark" className="mt-2" />
            ) : null}
            {trust.qualityLine ? (
