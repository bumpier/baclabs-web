...
export const bacteriostaticVsSterileWater: Guide = {
  ...
  quickAnswer: `Bacteriostatic water is sterile water with ${FACTS.benzylAlcoholPct} benzyl alcohol added as a preservative, so an opened vial can be used repeatedly for up to ${FACTS.openedLimit}. Plain sterile water has no preservative and is single-use once opened. Saline is 0.9% sodium chloride in sterile water, isotonic, and also unpreserved unless labelled bacteriostatic.`,
  updated: "2026-09-08",
  sections: [
    {
      ...
      paragraphs: [
        ...
        `**Bacteriostatic water** is purified water (CAS ${FACTS.casWater}) with ${FACTS.benzylAlcoholPct} benzyl alcohol (CAS ${FACTS.casBenzylAlcohol}) added as a preservative, which is ${FACTS.benzylAlcoholMgPerMl}. It is filtered, filled into a multi-use vial with a rubber stopper and crimped collar, and sterilised. In the United States the pharmacopoeial product is named Bacteriostatic Water for Injection, USP; in the UK it is sold as a laboratory and research diluent.`,
    ...
    },
    {
      ...
      paragraphs: [
        `There is only one real difference: bacteriostatic water contains ${FACTS.benzylAlcoholPct} benzyl alcohol and sterile water does not. Everything else that people list, such as purity, clarity, pH or sterility at the point of sealing, is the same for both. The water is the same water.`,
        `That one ingredient changes how the vial can be used. Once a stopper has been punctured, air and anything on the needle or in the room can enter the vial. In plain sterile water any bacteria introduced can multiply freely, so the vial is single-use and the remainder is discarded. In bacteriostatic water the benzyl alcohol inhibits bacterial growth, so the same vial can be entered repeatedly for up to ${FACTS.openedLimit}, the in-use limit printed on the label.`,
        "It is worth being precise about what the preservative does. Benzyl alcohol is bacteriostatic, not bactericidal: it slows and stops bacteria from multiplying, it does not sterilise, and it does not rescue a vial that has been contaminated or handled carelessly. Cloudiness, colour, particles or a vial past its in-use limit are all reasons to discard it regardless of the preservative.",
      ...
      table: {
        ...
        rows: [
          [
            "Preservative",
            `${FACTS.benzylAlcoholPct} benzyl alcohol (${FACTS.benzylAlcoholMgPerMl})`,
            "None",
    ...
    },
    {
      ...
      paragraphs: [
        "In a laboratory, often yes, and sometimes it is the better choice. The question to ask is whether the vial will be opened once or many times, and whether the benzyl alcohol would get in the way of the work.",
        ...
        "Sterile water is also the right choice where benzyl alcohol would interfere with the method. Benzyl alcohol absorbs in the ultraviolet, so it can distort UV spectrophotometry readings of a sample dissolved in it. It is toxic to many cell lines at the concentration used, so it is generally kept out of cell culture. It can appear as an extra peak in chromatography or mass spectrometry. In any of these cases an unpreserved solvent is the cleaner option.",
      ...
      list: [
        ...
        "Method is sensitive to benzyl alcohol (UV absorbance, cell culture, chromatography): sterile water is appropriate.",
    ...
    },
    {
      ...
      paragraphs: [
        "Bacteriostatic water and saline differ on two counts rather than one. Saline contains 0.9% sodium chloride and no preservative; bacteriostatic water contains 0.9% benzyl alcohol and no salt. They are chosen for different reasons and are not interchangeable in either direction.",
    ...
    },
    {
      ...
      paragraphs: [
        `Bacteriostatic saline is 0.9% sodium chloride in sterile water with ${FACTS.benzylAlcoholPct} benzyl alcohol added as a preservative. It combines the isotonicity of saline with the multi-use in-use period of bacteriostatic water, and it is packaged in the same kind of stoppered multi-use vial.`,
  ...
  faq: [
    {
      ...
      a: `No. Bacteriostatic water is sterile water with ${FACTS.benzylAlcoholPct} benzyl alcohol added as a preservative. The water itself is the same, but the preservative allows a bacteriostatic water vial to be used repeatedly for up to ${FACTS.openedLimit}, whereas sterile water is single-use once opened.`,
    },
    {
      q: "Can I use sterile water instead of bacteriostatic water?",
      a: "For single-session laboratory use, or where benzyl alcohol would interfere with an assay, plain sterile water is often the appropriate choice. It is not a substitute where a protocol specifies a preserved multi-use diluent, because sterile water has no in-use period once opened.",
    },
    {
      q: "Is saline the same as bacteriostatic water?",
      a: "No. Saline is 0.9% sodium chloride in sterile water with no preservative, chosen for its isotonicity. Bacteriostatic water contains 0.9% benzyl alcohol and no salt, chosen for its multi-use in-use period. Neither replaces the other.",
    },
    {
      q: "Does bacteriostatic water contain salt?",
      a: "No. Bacteriostatic water contains purified water and benzyl alcohol only. The product that contains both sodium chloride and benzyl alcohol is bacteriostatic saline, which is a separate product and is labelled as such.",
    },
    {
      q: "What is bacteriostatic saline?",
      a: `Bacteriostatic saline is 0.9% sodium chloride in sterile water preserved with ${FACTS.benzylAlcoholPct} benzyl alcohol. It is isotonic like saline and multi-use like bacteriostatic water. BacLab does not supply it.`,
    },
    {
      q: "Does the preservative in bacteriostatic water sterilise the vial?",
      a: "No. Benzyl alcohol inhibits bacterial growth after the stopper is punctured; it does not kill organisms already present and does not make a contaminated vial safe. Discard any vial that is cloudy, discoloured, contains particles or is past its in-use limit.",
    },
  ],
