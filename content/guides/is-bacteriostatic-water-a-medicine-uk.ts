...
export const isBacteriostaticWaterAMedicineUk: Guide = {
  ...
  quickAnswer: `No. No bacteriostatic water product holds a UK marketing authorisation, so it is not a licensed medicine and UK pharmacies do not generally stock it. In the UK it is sold as a laboratory reagent and diluent, sterile water with ${FACTS.benzylAlcoholPct} benzyl alcohol, not assessed by the MHRA and regulated as a chemical mixture and a consumer product instead.`,
  updated: "2026-09-08",
  sections: [
    {
    ...
    },
    {
      ...
      table: {
        ...
        rows: [
          ...
          ["Composition", `Sterile water with ${FACTS.benzylAlcoholPct} benzyl alcohol`, `Sterile water with ${FACTS.benzylAlcoholPct} benzyl alcohol`],
        ],
      },
    },
    {
    ...
    },
    {
      ...
      list: [
        `**Chemical classification and labelling.** The GB CLP Regulation requires every mixture placed on the market to be assessed against its hazard criteria. Pure benzyl alcohol is classified for acute toxicity and eye irritation, but a mixture only inherits those classifications above set concentration limits, and at ${FACTS.benzylAlcoholPct} the diluent falls below them. The outcome is recorded as: ${FACTS.hazardClassification}. No pictogram, signal word or hazard statement is required on the label.`,
        `**The safety data sheet.** UK REACH requires a safety data sheet for hazardous mixtures. Because this one is not classified, the law does not oblige a supplier to issue one, but a compliant seller publishes one anyway in the standard sixteen-section format. It lists the components by CAS number (water ${FACTS.casWater}, benzyl alcohol ${FACTS.casBenzylAlcohol}), the classification, first-aid and spillage measures, storage and disposal.`,
  ...
  faq: [
    ...
    },
    {
      ...
      a: `Strictly, no, because the mixture is not classified as hazardous at ${FACTS.benzylAlcoholPct} benzyl alcohol. A compliant seller provides one anyway, since it is the document a buyer's COSHH assessment relies on.`,
    },
  ],
