  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        `The ${FACTS.vialMl} ml vial is the size that is standard in UK laboratories. A product labelled as sterile water only, with no preservative stated, is not the same thing.`,
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Bacteriostatic water is the only one of the three that is both salt-free and preserved. The full comparison, including when the absence of a preservative matters, is in the guide on bacteriostatic water versus sterile water.",
      ],
      table: {
