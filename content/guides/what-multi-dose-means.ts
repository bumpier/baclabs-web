  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        `The stopper is the part people notice. It is an elastomer designed to close behind the needle rather than to be pierced once and thrown away, which is why [a multi-dose vial](/#buy) has a crimped collar and a flip cap rather than a snap top.`,
    ...
    },
    {
      ...
      paragraphs: [
        ...
        `The clock starts at first puncture and runs on the calendar. [It is not paused by refrigeration](/guides/how-to-store-bacteriostatic-water) and not extended by the vial being nearly full. Whatever is left on day ${FACTS.openedLimitDays} is discarded.`,
      ],
      table: {
